...
Versión alternativa usando serverless-wsgi para Vercel.
"""
...
# Usar serverless-wsgi para convertir Flask a formato Vercel
try:
    from serverless_wsgi import handle_request
    
    def handler(event, context):
        """Handler que usa serverless-wsgi para convertir Flask a formato Vercel."""
        return handle_request(app, event, context)
    
    application = handler
    
except ImportError:
    # Si serverless-wsgi no está disponible, exportar app directamente
    handler = app
    application = app
